...
<div class="container my-5" style="padding-bottom: 140px;">
    <div class="row justify-content-center my-4">
        ...
        <div class="col-md-9">
            <div class="row">
                <div class="col-ms-4">
                    <a class="btn btn-primary" href="<?php echo e(route('graduates.index')); ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="row my-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($user->email); ?>" style="font-size: 13px;" disabled>
                        </div>
                        <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yhm5jv201rtg/repositories/alumni-tracer/resources/views/profile/show.blade.php ENDPATH**/ ?>