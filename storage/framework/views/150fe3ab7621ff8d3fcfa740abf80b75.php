    ...
    <footer class="footer text-center text-lg-start bg-light text-muted py-2" style="margin-top: 18%;">
        <div class="container d-flex justify-content-between align-items-center">
            <p class="small mb-0 text-black">
                ...
                <a href="https://pcu.edu.ph/privacy-policy/" target="_blank" class="text-primary text-decoration-none">Privacy Policy</a> | 
...
<?php /**PATH /home/yhm5jv201rtg/repositories/alumni-tracer/resources/views/component/admin_footer.blade.php ENDPATH**/ ?>