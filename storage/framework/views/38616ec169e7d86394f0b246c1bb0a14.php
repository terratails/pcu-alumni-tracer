...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/component.css')); ?>">
</head>
<body>
    <footer class="footer text-center text-lg-start bg-light text-muted py-2" style="margin-top: 200px;">
        <div class="container d-flex justify-content-between align-items-center">
            <p class="small mb-0 text-black">&copy; 2023 All Rights Reserved | 
...
<?php /**PATH /volume1/web/htdocs/Alumni-Tracer/resources/views/component/admin_footer.blade.php ENDPATH**/ ?>