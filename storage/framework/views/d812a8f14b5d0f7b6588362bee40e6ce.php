...
<div id="app">
            ...
            <div class="container">
                <div class="logo">
                    <a href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('PCULogo.png')); ?>" alt="PCU Logo">
                    </div>
                </div>
    ...
    <div>
        <?php echo $__env->make('component.user_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

</body>
</html>
<?php /**PATH /home/yhm5jv201rtg/repositories/alumni-tracer/resources/views/layouts/clear.blade.php ENDPATH**/ ?>