...
<?php if(auth()->guard()->check()): ?>
    <?php echo $__env->make('component.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Show navbar for authenticated users -->
<?php endif; ?>

<?php if(auth()->guard()->guest()): ?>
    <?php echo $__env->make('component.guest-navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Show guest navbar for guests -->
<?php endif; ?>
            ...
            <div class="button-section">
                    <div class="row d-flex justify-content-center w-100">
                        <div class="col-md-3 col-5">
                            <a class="btn btn-primary agree-btn" href="<?php echo e(url('agree')); ?>">I Agree</a>                     
                        </div>
                        <div class="col-md-3 col-5">
                            <a class="btn disagree-btn" href="<?php echo e(url('/')); ?>">I Disagree</a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH /home/yhm5jv201rtg/repositories/alumni-tracer/resources/views/component/banner.blade.php ENDPATH**/ ?>