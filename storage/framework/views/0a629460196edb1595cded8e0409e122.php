...
<body style="background-color: white;">
    ...
    <?php if(auth()->check() && auth()->user()->password_reset_required && auth()->user()->role === 'user'): ?>
    ...
    <div class="modal" id="passwordResetModal" tabindex="-1" role="dialog" aria-labelledby="passwordResetModalLabel" aria-hidden="true">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('password.reset.first')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.clear', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yhm5jv201rtg/repositories/alumni-tracer/resources/views/user/home.blade.php ENDPATH**/ ?>