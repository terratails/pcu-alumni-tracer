        ...
        <div class="col-smd-6 col-lg-4 column">
            <div class="card shadow rounded" style="border: none;">
                ...
                <div class="card-body">
                    ...
                    <p class="text-secondary"><i class="fa fa-calendar"></i> updated <?php echo e(\Carbon\Carbon::now()->diffForHumans()); ?></p>
                </div>
            </div>
        </div>
...
<script>
    const rawLabels = <?php echo json_encode($last7Days->pluck('date'), 15, 512) ?>;
    const dataCounts = <?php echo json_encode($last7Days->pluck('count'), 15, 512) ?>;
    ...
    const userLabels = <?php echo json_encode($userCounts->pluck('date')->map(fn($date) => \Carbon\Carbon::parse($date)->format('M d')), 15, 512) ?>;
    const userData = <?php echo json_encode($userCounts->pluck('count'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yhm5jv201rtg/repositories/alumni-tracer/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>