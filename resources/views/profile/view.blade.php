...
<div class="container my-5" style="padding-bottom: 140px;">
    <div class="row justify-content-center my-4">
        ...
        <div class="col-md-9">
            <div class="row">
                <div class="col-ms-4">
                    <a class="btn btn-primary" href="{{ Auth::user()->role === 'user' ? route('user.home') : route('admin.home') }}">
                        <i class="bi bi-house"></i> Home
                    </a>

                    @if(Auth::user()->role !== 'admin')
                        <a class="btn btn-secondary mx-2" href="{{ route('profile.edit') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="row my-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ Auth::user()->email }}" style="font-size: 13px;" disabled>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    @if ($tracer)
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-3">
                                <label class="form-label text-muted">Doctoral Degree</label>
